...
    SEND_CHAT_START = "SEND_CHAT_START"             # 代表每条消息的开始

    SEND_CHAT_CONTENT = "SEND_CHAT_CONTENT"

    SEND_THOUGHT_CONTENT = "SEND_THOUGHT_CONTENT"

    SEND_TOOL_CALLING = "SEND_TOOL_CALLING"         # 代表模型使用工具的返回结果

    SEND_CHAT_END = "SEND_CHAT_END"                 # 代表每条消息的结束
