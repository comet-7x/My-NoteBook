...
核心问答接口，支持流式返回 (Server-Sent Events, SSE)。支持“思考模式”和“快速模式”。遵循[Agent交互协议](https://steinstech.feishu.cn/wiki/G9DawtbgkichlvkoYmicei0BnGb)
- **接口路径**: `/chat`
...
|---|---|
|事件|解释|
|`SEND_CHAT_START`|对话开始|
|`SEND_THOUGHT_CONTENT`|思考过程内容块|
|`SEND_COMMON_CONTENT`|普通回答内容块|
|`SEND_TOOL_CALL`|工具调用信息|
|`SEND_CHAT_END`|对话结束|
|`SEND_CHAT_ERROR`|对话异常|
