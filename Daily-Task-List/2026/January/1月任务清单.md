...
1. Determine the type of the user question:
   - If the problem falls under routine or general logic, such as greetings, polishing, code logic, etc. After confirming the intention in "Thought", skip "Action" and directly output "Final Answer".
   - 
