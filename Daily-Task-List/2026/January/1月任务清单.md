...
- rag_search: A professional engine for retrieving global academic and industrial knowledge to support high-level research and fact-verification, etc.
  - Instruction Guidelines:
    ...
    6. Core Utility: Use this tool to cross-reference claims, identify research gaps, and provide objective data points. Avoid anecdotal evidence; rely strictly on retrieved scholarly records.
