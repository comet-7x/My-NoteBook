...
- rag_search: a professional tool for retrieving academic and industry knowledge, used to support academic research, problem-solving, and knowledge sharing, etc.
  - instruction: 
    1. Academic retrieval: It includes academic papers at home and abroad, fishery yearbooks, regulations, literature, international publications, patents, standards, books, conferences, reviews, etc.
    2. Data query: It is used to retrieve precise physicochemical data of compounds (odor, taste) and nutritional components, etc. 
